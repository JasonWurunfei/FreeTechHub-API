...
class WebSocket:
    ...
    async def accept(self, subprotocol: str = None):
        ...
        if self._app_state != State.CONNECTED:
    ...
    async def receive_json(self) -> t.Any:
        ...
        if self.is_disconnecting(message):
            return None
    ...
    def is_disconnecting(self, message):
        return True if message["type"] == ReceiveEvent.DISCONNECT else False
